  ...
  <q-card class="full-width" v-if="selectedPlayer">
    <q-card-section class="q-pa-none">
      <div class="flex flex-col sm:flex-row gap-2">
        <div class="flex-1 q-pa-sm md:min-w-[400px]">
          <PlayerProfile />
        </div>
        <div class="flex-1 q-pa-sm flex justify-center content-start">
          <q-chip
    ...
    <q-card-section class="flex flex-col sm:flex-row gap-2 justify-start q-pt-none q-pb-sm q-px-sm">
      <q-btn
