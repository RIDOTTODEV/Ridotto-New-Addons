...
const expansionItemHeaders = ref({
  showCashFiguresHeader: true,
  showCumulativeTransactionFiguresHeader: true,
  showDailyTransactionFiguresHeader: true,
  showInternalTransfersHeader: true,
  showCashRateChangesHeader: true,
  showDailyRateChangesHeader: true,
  showSlotRevenuesHeader: true,
  showChipFiguresHeader: true,
})
const expansionItemsHeaderAction = (headerKey, value) => {
  expansionItemHeaders.value[headerKey] = value
}
const demo = ref('')
    ...
    <div class="row grey-card q-mt-md">
      ...
      <q-card class="no-box-shadow col-12">
        <q-expansion-item
          ...
          header-class="grey-card"
          v-if="balanceReport.cashFigures !== null"
          ref="expansionItemCashFigures"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showCashFiguresHeader',
                !expansionItemHeaders.showCashFiguresHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold text-capitalize">
                  Cash Figures
                  <span
                    class="q-ml-md text-deep-orange-10"
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.cumulativeReportTransactionFigures !== null"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showCumulativeTransactionFiguresHeader',
                !expansionItemHeaders.showCumulativeTransactionFiguresHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold">
                  ...
                  <span
                    class="q-ml-md text-deep-orange-10"
                    v-if="expansionItemHeaders.showCumulativeTransactionFiguresHeader"
                  >
                    Movement:
                    {{
                      priceAbsFormatted(
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.dailyTransactionFigures !== null"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showDailyTransactionFiguresHeader',
                !expansionItemHeaders.showDailyTransactionFiguresHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold">
                  ...
                  <span
                    class="q-ml-md text-deep-orange-10"
                    v-if="expansionItemHeaders.showDailyTransactionFiguresHeader"
                  >
                    Movement:
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.cashRateChanges !== null"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showCashRateChangesHeader',
                !expansionItemHeaders.showCashRateChangesHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold">
                  ...
                  <span
                    class="q-ml-md text-deep-orange-10"
                    v-if="expansionItemHeaders.showCashRateChangesHeader"
                  >
                    Total Difference:
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.dailyRateChangeReport !== null"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showDailyRateChangesHeader',
                !expansionItemHeaders.showDailyRateChangesHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-4">
                <div class="text-subtitle1 text-bold">
                  ...
                  <span
                    class="q-ml-md text-deep-orange-10"
                    v-if="expansionItemHeaders.showDailyRateChangesHeader"
                  >
                    Total Profit:
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.internalTransfers !== null"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showInternalTransfersHeader',
                !expansionItemHeaders.showInternalTransfersHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold">
                  ...
                  <span
                    class="q-ml-md text-deep-orange-10"
                    v-if="expansionItemHeaders.showInternalTransfersHeader"
                  >
                    Movement: 0
                  </span>
                </div>
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.slotRevenues !== null"
          ref="expansionItemCashFigures"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showSlotRevenuesHeader',
                !expansionItemHeaders.showSlotRevenuesHeader,
              )
          "
          @hide="
            () =>
            ...
            <div class="row full-width">
              <div class="col-12">
                <div class="text-subtitle1 text-bold">
                  Slot Revenues
                  <span
                    class="q-ml-md text-deep-orange-10 text-capitalize"
                    v-if="expansionItemHeaders.showSlotRevenuesHeader"
                  >
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.dayBeforeRates !== null || balanceReport.currentRates !== null"
        >
          <template v-slot:header>
            <div class="row col-12">
              <div class="text-subtitle1 text-bold">Exchange Rates</div>
            </div>
          </template>
          <div class="row">
            <Information
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.transactionLogs !== null"
        >
          <template v-slot:header>
            <div class="row col-12">
              <div class="text-subtitle1 text-bold">Transaction Logs</div>
            </div>
          </template>
          <div class="row">
            <Information
        ...
        <q-expansion-item
          ...
          class="col-12 q-mt-sm"
          header-class="grey-card"
          v-if="balanceReport.chipFigures !== null"
          ref="expansionItemChipFigures"
          @show="
            () =>
              expansionItemsHeaderAction(
                'showChipFiguresHeader',
                !expansionItemHeaders.showChipFiguresHeader,
              )
          "
          @hide="
            () =>
